...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Проверяем сертификаты качества и документы на соответствие требованиям ЕАЭС и международным стандартам."
  },
  {
    icon: FileCheck,
          ...
          <div className={styles.containerGridTwo}>
            <Reveal className={styles.heroTextBlock}>
              ...
              <p>
                ...
                поставщика до доставки на ваш склад или производство.
              </p>
